...
namespace Perscription.Migrations
{
    ...
    [Migration("20230524140159_SaltRefToken")]
    partial class SaltRefToken
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Perscription.Models.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IdUser = 1,
                            Login = "Adam",
                            Password = "fA9OkfqwmJHw9BUK1xvT1BmWBKhEt9cEqX+sQCfi2JI=",
                            Salt = "0a9fc25a-9456-4f5d-906d-579c71c3179c"
                        });
                });
            ...
            modelBuilder.Entity("Perscription.Models.Patient", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPatient = 1,
                            BirthDate = new DateTime(2023, 5, 24, 16, 1, 59, 130, DateTimeKind.Local).AddTicks(1662),
                            FirstName = "Adam",
                            LastName = "Kowalski"
                        },
                        new
                        {
                            IdPatient = 2,
                            BirthDate = new DateTime(2023, 5, 24, 16, 1, 59, 130, DateTimeKind.Local).AddTicks(1718),
                            FirstName = "Jan",
                            LastName = "Kabacki"
                        });
                });
            ...
            modelBuilder.Entity("Perscription.Models.Prescription", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPrescription = 1,
                            Date = new DateTime(2023, 5, 24, 16, 1, 59, 134, DateTimeKind.Local).AddTicks(7664),
                            DueDate = new DateTime(2023, 5, 24, 16, 1, 59, 134, DateTimeKind.Local).AddTicks(7697),
                            IdDoctor = 2,
                            IdPatient = 1
                        },
                        new
                        {
                            IdPrescription = 2,
                            Date = new DateTime(2023, 5, 24, 16, 1, 59, 134, DateTimeKind.Local).AddTicks(7702),
                            DueDate = new DateTime(2023, 5, 24, 16, 1, 59, 134, DateTimeKind.Local).AddTicks(7703),
                            IdDoctor = 2,
                            IdPatient = 2
                        });
                });
