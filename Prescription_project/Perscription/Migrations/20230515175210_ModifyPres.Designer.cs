...
namespace Perscription.Migrations
{
    ...
    [Migration("20230515175210_ModifyPres")]
    partial class ModifyPres
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Perscription.Models.Patient", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPatient = 1,
                            BirthDate = new DateTime(2023, 5, 15, 19, 52, 10, 30, DateTimeKind.Local).AddTicks(7407),
                            FirstName = "Adam",
                            LastName = "Kowalski"
                        },
                        new
                        {
                            IdPatient = 2,
                            BirthDate = new DateTime(2023, 5, 15, 19, 52, 10, 30, DateTimeKind.Local).AddTicks(7461),
                            FirstName = "Jan",
                            LastName = "Kabacki"
                        });
                });
            ...
            modelBuilder.Entity("Perscription.Models.Prescription", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPrescription = 1,
                            Date = new DateTime(2023, 5, 15, 19, 52, 10, 30, DateTimeKind.Local).AddTicks(7568),
                            DueDate = new DateTime(2023, 5, 15, 19, 52, 10, 30, DateTimeKind.Local).AddTicks(7570),
                            IdDoctor = 2,
                            IdPatient = 1
                        },
                        new
                        {
                            IdPrescription = 2,
                            Date = new DateTime(2023, 5, 15, 19, 52, 10, 30, DateTimeKind.Local).AddTicks(7574),
                            DueDate = new DateTime(2023, 5, 15, 19, 52, 10, 30, DateTimeKind.Local).AddTicks(7576),
                            IdDoctor = 2,
                            IdPatient = 2
                        });
                });
