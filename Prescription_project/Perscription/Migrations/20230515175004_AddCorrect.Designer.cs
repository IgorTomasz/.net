...
namespace Perscription.Migrations
{
    ...
    [Migration("20230515175004_AddCorrect")]
            ...
            modelBuilder.Entity("Perscription.Models.Patient", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPatient = 1,
                            BirthDate = new DateTime(2023, 5, 15, 19, 50, 4, 0, DateTimeKind.Local).AddTicks(239),
                            FirstName = "Adam",
                            LastName = "Kowalski"
                        },
                        new
                        {
                            IdPatient = 2,
                            BirthDate = new DateTime(2023, 5, 15, 19, 50, 4, 0, DateTimeKind.Local).AddTicks(295),
                            FirstName = "Jan",
                            LastName = "Kabacki"
                        });
                });
            ...
            modelBuilder.Entity("Perscription.Models.Prescription", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPerscription = 1,
                            Date = new DateTime(2023, 5, 15, 19, 50, 4, 0, DateTimeKind.Local).AddTicks(419),
                            DueDate = new DateTime(2023, 5, 15, 19, 50, 4, 0, DateTimeKind.Local).AddTicks(422),
                            IdDoctor = 2,
                            IdPatient = 1
                        },
                        new
                        {
                            IdPerscription = 2,
                            Date = new DateTime(2023, 5, 15, 19, 50, 4, 0, DateTimeKind.Local).AddTicks(426),
                            DueDate = new DateTime(2023, 5, 15, 19, 50, 4, 0, DateTimeKind.Local).AddTicks(428),
                            IdDoctor = 2,
                            IdPatient = 2
                        });
                });
