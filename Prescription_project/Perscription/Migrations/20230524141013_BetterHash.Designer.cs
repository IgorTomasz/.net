...
namespace Perscription.Migrations
{
    ...
    [Migration("20230524141013_BetterHash")]
    partial class BetterHash
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Perscription.Models.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IdUser = 1,
                            Login = "Adam",
                            Password = "nrrXEBi7LT/6ADxIiDx/tkwdX3YGfdOwESUakNJeCWI=",
                            Salt = "671cd4cb-429c-4e79-9d8e-db5a9e29ae67"
                        });
                });
            ...
            modelBuilder.Entity("Perscription.Models.Patient", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPatient = 1,
                            BirthDate = new DateTime(2023, 5, 24, 16, 10, 13, 746, DateTimeKind.Local).AddTicks(7418),
                            FirstName = "Adam",
                            LastName = "Kowalski"
                        },
                        new
                        {
                            IdPatient = 2,
                            BirthDate = new DateTime(2023, 5, 24, 16, 10, 13, 746, DateTimeKind.Local).AddTicks(7476),
                            FirstName = "Jan",
                            LastName = "Kabacki"
                        });
                });
            ...
            modelBuilder.Entity("Perscription.Models.Prescription", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPrescription = 1,
                            Date = new DateTime(2023, 5, 24, 16, 10, 13, 750, DateTimeKind.Local).AddTicks(8918),
                            DueDate = new DateTime(2023, 5, 24, 16, 10, 13, 750, DateTimeKind.Local).AddTicks(8925),
                            IdDoctor = 2,
                            IdPatient = 1
                        },
                        new
                        {
                            IdPrescription = 2,
                            Date = new DateTime(2023, 5, 24, 16, 10, 13, 750, DateTimeKind.Local).AddTicks(8929),
                            DueDate = new DateTime(2023, 5, 24, 16, 10, 13, 750, DateTimeKind.Local).AddTicks(8930),
                            IdDoctor = 2,
                            IdPatient = 2
                        });
                });
